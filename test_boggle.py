...
class TestBoggle(unittest.TestCase):
    """
    Our test suuite for boggle solver
    """
    ...
    def test_search_grid_for_words(self): 
        ...
        twoLetterWord = 'AB'
        threeeLetterWord = 'ABC'
        notThereWord = 'EEE'
        dictionary = [twoLetterWord, threeeLetterWord, notThereWord]
        
        foundWords = boggle.search(grid, dictionary)
        
        self.assertTrue(twoLetterWord in foundWords)
        self.assertTrue(threeeLetterWord in foundWords)
